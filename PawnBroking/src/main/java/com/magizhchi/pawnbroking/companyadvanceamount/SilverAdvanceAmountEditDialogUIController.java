 ...
 * @author Tiru
 */
public class SilverAdvanceAmountEditDialogUIController implements Initializable {
    ...
    int index = -1;
    private SilverAdvanceAmountController parent;
    ...
    public void setParent(SilverAdvanceAmountController parent, boolean isDialogForAdd)
    {
        this.parent = parent;
