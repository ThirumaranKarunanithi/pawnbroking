 ...
 * @author Tiru
 */
public class GoldOpenFormulaDialogUIController implements Initializable {

    private CompanyMasterController parent;
    private boolean isDialogForAdd;
    private ArrayList<String> lastSelectedText = new ArrayList<>();
    ...
    @FXML
    private ComboBox<String> cbSymbols;
    @FXML
    private ComboBox<String> cbOthers;
    @FXML
    ...
    private void onSaveClicked(ActionEvent event) {
        ...
        int index = this.parent.tbGBOFormula.getSelectionModel().getSelectedIndex();
        
        if(isDialogForAdd) {
            this.parent.tbGBOFormula.getItems().add(new FormulaBean(sFromDate, sToDate, dFrom, dTo, sFormula));                    
        } else {
            this.parent.tbGBOFormula.getItems().set(index, new FormulaBean(sFromDate, sToDate, dFrom, dTo, sFormula));                    
        }
    ...
    public void setInitValues() {
        ...
        {
            int index = this.parent.tbGBOFormula.getSelectionModel().getSelectedIndex();
            FormulaBean bean = this.parent.tbGBOFormula.getItems().get(index);
