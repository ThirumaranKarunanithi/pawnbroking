 ...
 * @author Tiru
 */
public class SilverCloseFormulaDialogUIController implements Initializable {
    ...
    private void onSaveClicked(ActionEvent event) {
        ...
        int index = this.parent.tbSBCFormula.getSelectionModel().getSelectedIndex();
        
        if(isDialogForAdd) {
            this.parent.tbSBCFormula.getItems().add(new FormulaBean(sFromDate, sToDate, dFrom, dTo, sFormula));                    
        } else {
            this.parent.tbSBCFormula.getItems().set(index, new FormulaBean(sFromDate, sToDate, dFrom, dTo, sFormula));                    
        }
    ...
    public void setInitValues() {
        ...
        {
            int index = this.parent.tbSBCFormula.getSelectionModel().getSelectedIndex();
            FormulaBean bean = this.parent.tbSBCFormula.getItems().get(index);
