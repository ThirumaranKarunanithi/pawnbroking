 ...
 * @author Tiru
 */
public class SilverMonthSettingDialogUIController implements Initializable {
    ...
    private void onSaveClicked(ActionEvent event) {
        ...
        int index = this.parent.tbSBMS.getSelectionModel().getSelectedIndex();
        
        if(isDialogForAdd) {
            this.parent.tbSBMS.getItems().add(new MonthSettingBean(sFromDate, sToDate, dFrom, dTo, dAsMonth));                    
        } else {
            this.parent.tbSBMS.getItems().set(index, new MonthSettingBean(sFromDate, sToDate, dFrom, dTo, dAsMonth));                    
        }
    ...
    public void setInitValues() {
        ...
        {
            int index = this.parent.tbSBMS.getSelectionModel().getSelectedIndex();
            MonthSettingBean bean = this.parent.tbSBMS.getItems().get(index);
