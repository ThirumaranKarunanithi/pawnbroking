 ...
 * @author Tiru
 */
public class SilverOpenDocumentChargeDialogUIController implements Initializable {
    ...
    private void onSaveClicked(ActionEvent event) {
        ...
        int index = this.parent.tbSBODocumentCharge.getSelectionModel().getSelectedIndex();
        
        if(isDialogForAdd) {
            this.parent.tbSBODocumentCharge.getItems().add(new DocumentChargeBean(sFromDate, sToDate, dFrom, dTo, dDocumentCharge));                    
        } else {
            this.parent.tbSBODocumentCharge.getItems().set(index, new DocumentChargeBean(sFromDate, sToDate, dFrom, dTo, dDocumentCharge));                    
        }
    ...
    public void setInitValues() {
        ...
        {
            int index = this.parent.tbSBODocumentCharge.getSelectionModel().getSelectedIndex();
            DocumentChargeBean bean = this.parent.tbSBODocumentCharge.getItems().get(index);
