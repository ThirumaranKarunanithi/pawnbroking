 ...
 * @author Tiru
 */
public class SilverOpenFormulaDialogUIController implements Initializable {
    ...
    private void onSaveClicked(ActionEvent event) {
        ...
        int index = this.parent.tbSBOFormula.getSelectionModel().getSelectedIndex();
        
        if(isDialogForAdd) {
            this.parent.tbSBOFormula.getItems().add(new FormulaBean(sFromDate, sToDate, dFrom, dTo, sFormula));                    
        } else {
            this.parent.tbSBOFormula.getItems().set(index, new FormulaBean(sFromDate, sToDate, dFrom, dTo, sFormula));                    
        }
    ...
    public void setInitValues() {
        ...
        {
            int index = this.parent.tbSBOFormula.getSelectionModel().getSelectedIndex();
            FormulaBean bean = this.parent.tbSBOFormula.getItems().get(index);
