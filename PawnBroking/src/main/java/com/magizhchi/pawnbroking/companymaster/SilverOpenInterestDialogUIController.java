 ...
 * @author Tiru
 */
public class SilverOpenInterestDialogUIController implements Initializable {
    ...
    private void onSaveClicked(ActionEvent event) {
        ...
        double dInterest = Double.parseDouble(txtInterest.getText());
        int index = this.parent.tbSBOInterest.getSelectionModel().getSelectedIndex();
        
        if(isDialogForAdd) {
            this.parent.tbSBOInterest.getItems().add(new InterestBean(sFromDate, sToDate, dFrom, dTo, dInterest));                    
        } else {
            this.parent.tbSBOInterest.getItems().set(index, new InterestBean(sFromDate, sToDate, dFrom, dTo, dInterest));                    
        }
    ...
    public void setInitValues() {
        ...
        {
            int index = this.parent.tbSBOInterest.getSelectionModel().getSelectedIndex();
            InterestBean bean = this.parent.tbSBOInterest.getItems().get(index);
            ...
            txtInterest.setText(Double.toString(bean.getDInterest()));
        }
    }
}
