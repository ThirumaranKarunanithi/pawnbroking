...
public class EmployeeAdvanceAmountReductionDialogUIController implements Initializable {
    ...
    EmployeeDebitController parent = null;
    int reduceCount = 0;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        //tbReduce.getItems().add(new EmployeeReduceBean("1", "12", "12-12-12", "sdfsdg", 500.0, false));
    }    
    ...
    public void setParent(EmployeeDebitController parent) {
