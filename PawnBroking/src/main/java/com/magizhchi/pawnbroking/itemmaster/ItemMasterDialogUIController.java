...
public class ItemMasterDialogUIController implements Initializable {
    ...
    private void onSaveClicked(ActionEvent event) {
        ...
        if(isDialogForAdd) {
            try {
                if(this.parent.dbOp.isvalidItemToSave(sItem, "GOLD")) {
                    if(this.parent.dbOp.saveItem(sItem, sStatus, "GOLD")) {
                        this.parent.setJewelItemValues("GOLD");
            ...
            try {
                if(this.parent.dbOp.updateItem(sItem, sStatus, "GOLD")) {
                    this.parent.setJewelItemValues("GOLD");
                    this.parent.dialog.close();
                }
            } catch (Exception ex) {
    ...
    public void setInitValues() {
        ...
        if(!isDialogForAdd)
        {
            ...
            int index = this.parent.tbGItems.getSelectionModel().getSelectedIndex();
            ItemsBean bean = this.parent.tbGItems.getItems().get(index);
