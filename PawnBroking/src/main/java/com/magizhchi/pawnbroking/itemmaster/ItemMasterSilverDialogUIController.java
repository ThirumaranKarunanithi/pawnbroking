 ...
 * @author Tiru
 */
public class ItemMasterSilverDialogUIController implements Initializable {
    ...
    private ItemMasterController parent;
    ...
    private void onSaveClicked(ActionEvent event) {
        ...
        if(isDialogForAdd) {
            try {
                if(this.parent.dbOp.isvalidItemToSave(sItem, "SILVER")) {
                    if(this.parent.dbOp.saveItem(sItem, sStatus, "SILVER")) {
                        this.parent.setJewelItemValues("SILVER");
            ...
            try {
                if(this.parent.dbOp.updateItem(sItem, sStatus, "SILVER")) {
                    this.parent.setJewelItemValues("SILVER");
                    this.parent.dialog.close();
                }
            } catch (Exception ex) {
    ...
    public void setParent(ItemMasterController parent, boolean isDialogForAdd)
    {
        this.parent = parent;
    ...
    public void setInitValues() {
        ...
        if(!isDialogForAdd)
        {
            ...
            int index = this.parent.tbSItems.getSelectionModel().getSelectedIndex();
            ItemsBean bean = this.parent.tbSItems.getItems().get(index);
