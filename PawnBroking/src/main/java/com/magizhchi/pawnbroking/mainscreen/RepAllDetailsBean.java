...
public class RepAllDetailsBean {
    ...
    private SimpleStringProperty sRepledgeBillNumber;
    ...
    public RepAllDetailsBean(String sRepledgeBillId, String sRepledgeId, 
            String sRepledgeBillNumber, String sRepledgeName, 
            String sCompBillNumber, 
    ...
    /**
     * @return the sRepledgeBillNumber
     */
    ...
    /**
     * @param sRepledgeBillNumber the sRepledgeBillId to set
     */
