...
public class RepledgeBillClosingDialogUIController implements Initializable {
    ...
    private RepledgeGoldBillOpeningController parent;
    ...
    private void tbRNYDeliveredOnMouseClicked(MouseEvent event) {            
        ...
        if (event.getClickCount() == 1 && (index >= 0) ) {
            ...
            parent.tbDialogTablesOnMouseClicked(sRepledgeBillId);
        }
        parent.dialog.close();
    }
    
    public void setParent(RepledgeGoldBillOpeningController parent)
    {
        this.parent = parent;
    }
