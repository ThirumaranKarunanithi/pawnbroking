...
public class FormulaBean {
    ...
    private final SimpleStringProperty sFormula;

    public FormulaBean(String sFromDate, String sToDate, double dFrom, double dTo, String sFormula) {
        ...
        this.sFormula = new SimpleStringProperty(sFormula);
    }
