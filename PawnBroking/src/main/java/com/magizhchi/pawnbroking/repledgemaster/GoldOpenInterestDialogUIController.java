 ...
 * @author Tiru
 */
public class GoldOpenInterestDialogUIController implements Initializable {
    ...
    private void onSaveClicked(ActionEvent event) {
        ...
        int index = this.parent.tbGBOInterest.getSelectionModel().getSelectedIndex();
        
        if(isDialogForAdd) {
            this.parent.tbGBOInterest.getItems().add(new InterestBean(sFromDate, sToDate, dFrom, dTo, dInterest));                    
        } else {
            this.parent.tbGBOInterest.getItems().set(index, new InterestBean(sFromDate, sToDate, dFrom, dTo, dInterest));                    
        }
    ...
    public void setInitValues() {
        ...
        {
            int index = this.parent.tbGBOInterest.getSelectionModel().getSelectedIndex();
            InterestBean bean = this.parent.tbGBOInterest.getItems().get(index);
