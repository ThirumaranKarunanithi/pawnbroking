 ...
 * @author tiruk
 */
public class ShopBillStockDialogUIController implements Initializable {
    ...
    private void onSaveClicked(ActionEvent event) {
        if(dtFromDate.getValue() != null && dtToDate.getValue() != null) {
            ...
            try {
                ...
                List<ShopLockerPrintBean> ParamList 
                        = dbOp.shopBillStock(sMaterialType, sFromDate, sToDate);

                JRBeanCollectionDataSource tableList 
                ...
                parameters.put("MATERIALTYPE", "Shop Bill Stock for " + sMaterialType);
